            ...
            <div className='md:w-3/4 sm:w-4/5 mx-auto'>
                <div className='pt-64 bg-gray-900'>
                    <ul className='bg-gray-900 ml-10'>
                        <li className='text-semibold text-gray-400 text-xl -m-2 xs:text-sm'>Designed by Nono Umasy</li>
                        <li className='text-semibold text-gray-400 text-xl -m-2 xs:text-sm'>Los Angeles, Tokyo, Lisbon</li>
                        <li className='text-semibold text-gray-400 text-xl -m-2 xs:text-sm'>hello@tokyohoods</li>
                    </ul>
