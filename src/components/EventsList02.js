                ...
                <div className='w-4/5'>
                    ...
                    <div className='flex justify-between items-center mt-3'>
                        ...
                        <div className='flex '>
                            ...
                            <button className='bg-gray-200 text-xs text-gray-600 uppercase tracking-widest hover:bg-gray-300 font-bold px-6 py-3 rounded mr-10'>Month</button>
                        </div>
                    ...
                    <div className='mt-6 grid md:grid-cols-2 xl:grid-cols-3 gap-2 justify-center relative'>
                        ...
                        <div className='card mb-4 bg-gray-100 rounded-lg hover:rounded-lg hover:shadow-2xl hover:bg-white p-4'>
                            <div className='px-6 py-4'>
                                ...
                                <div className='mb-6 mt-6 font-light text-justify text-sm md:h-32 sm:h-24'>Kawasaki’s La Cittadella shopping complex is holding its annual summertime event. This year’s theme is “Night Out”, where guests can join a chilled-out alfresco dining experience.</div>
                        ...
                        <div className='card mb-4 bg-gray-100 rounded-lg hover:rounded-lg hover:shadow-2xl hover:bg-white p-4'>
                            <div className='px-6 py-4'>
                                ...
                                <div className='mb-6 mt-6  font-light text-justify text-sm md:h-32 sm:h-24'>An evening event in which candle-lit lanterns are floated down the Sumida River. Toro nagashi is a tradition in which lanterns lit with candles are set afloat on rivers to guide the spirits of the ancestors back to the other side during the O-bon holiday.</div>
